...
SPO2 spo2;
KALMAN corr_filter(CORR_KALMAN_LENGTH, CORR_DATA_LENGTH, MAX_OUTLIER_COUNT, MAX_ALG_FAIL_COUNT, CORR_MIN_STD_1F, CORR_KALMAN_THRESHOLD_2X, NO_JUMPS);
KALMAN hr_filter(HR_KALMAN_LENGTH, HR_DATA_LENGTH, MAX_OUTLIER_COUNT, MAX_ALG_FAIL_COUNT, HR_MIN_STD_1F, HR_KALMAN_THRESHOLD_2X, NO_JUMPS);
KALMAN spo2_filter(SPO2_KALMAN_LENGTH, SPO2_DATA_LENGTH, MAX_OUTLIER_COUNT, MAX_ALG_FAIL_COUNT, SPO2_MIN_STD_1F, SPO2_KALMAN_THRESHOLD_2X, JUMPS_OK);
...
KALMAN rr_breath_filter(RR_KALMAN_LENGTH, RR_DATA_LENGTH, MAX_OUTLIER_COUNT, MAX_ALG_FAIL_COUNT, RR_MIN_STD_1F, RR_KALMAN_THRESHOLD_2X, NO_JUMPS);
...
{
  //spo2.set_filters(&corr_filter,&hr_filter,&spo2_filter,&rr_breath_filter,&short_breath_filter,&breath_filter);
  spo2.set_filters(&corr_filter,&hr_filter,&spo2_filter,&rr_breath_filter);
