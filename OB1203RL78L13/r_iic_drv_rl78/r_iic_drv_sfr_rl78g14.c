...
/********************************************************************************************************************
* File Name     : r_iic_drv_sfr_rl78g14.c
* Version       : 1.03
* Device(s)     : RL78/G14
* Tool-Chain    : -
*               : 
...
void r_iic_drv_io_open(r_iic_drv_info_t *pRIic_Info)
{
    ...
    switch (pRIic_Info->ChNo)
    {
        ...
        case 1U:                                                /* Channel 1                                        */
#ifdef IICA1_ENABLE
            R_IIC_P_SCL1    = R_IIC_LOW;                        /* SCL1 output latch value setting to Low           */
            R_IIC_P_SDA1    = R_IIC_LOW;                        /* SDA1 output latch value setting to Low           */

            R_IIC_PM_SCL1   = R_IIC_IN;                         /* SCL1 input mode                                  */
            R_IIC_PM_SDA1   = R_IIC_IN;                         /* SDA1 input mode                                  */
...
void r_iic_drv_io_init(r_iic_drv_info_t *pRIic_Info)
{
    ...
    switch (pRIic_Info->ChNo)
    {
        ...
        case 1U:                                                /* Channel 1                                        */
            ...
            R_IIC_PM_SCL1   = R_IIC_OUT;                        /* SCL1 output mode                                 */
            R_IIC_PM_SDA1   = R_IIC_OUT;                        /* SDA1 output mode                                 */
...
void r_iic_drv_clk_low(r_iic_drv_info_t *pRIic_Info)
{
    ...
    switch (pRIic_Info->ChNo)
    {
        ...
        case 1U:                                                /* Channel 1                                        */
#ifdef IICA1_ENABLE
            R_IIC_P_SCL1    = R_IIC_LOW;                        /* SCL1 output latch setting to Low                 */
            R_IIC_PM_SCL1   = R_IIC_OUT;                        /* SCL1 output mode.                                */
            R_IIC_P_SCL1    = R_IIC_LOW;                        /* SCL1 output latch setting to Low                 */
#endif /* #ifdef IICA1_ENABLE */
        break;
...
void r_iic_drv_int_disable(r_iic_drv_info_t *pRIic_Info)
{
    ...
    switch (pRIic_Info->ChNo)
    {
        ...
        case 1U:                                                /* Channel 1                                        */
#ifdef IICA1_ENABLE
            IICAMK1 = R_IIC_CH1_MK_DISABLE;                     /* Disables interruption.                           */
            IICAIF1 = R_IIC_CH1_IF_INIT;                        /* Clears interruption flag.                        */

            /* Sets interruption level. */
            IICAPR01 = R_IIC_CH1_PR0_INIT;
            IICAPR11 = R_IIC_CH1_PR1_INIT;
#endif /* #ifdef IICA1_ENABLE */
        break;
...
#ifdef IICA1_ENABLE
            IICAIF1 = R_IIC_CH1_IF_INIT;                        /* Clears interruption flag.                        */
            IICAMK1 = R_IIC_CH1_MK_ENABLE;                      /* Enables interruption.                            */
#endif /* #ifdef IICA1_ENABLE */
        break;
...
void r_iic_drv_set_frequency(r_iic_drv_info_t *pRIic_Info)
{
    ...
    switch (pRIic_Info->ChNo)
    {
        ...
        case 1U:
#ifdef IICA1_ENABLE                                             /* Channel 1                                        */
            *pcIICWL = R_IIC_CH1_LCLK;                          /* Low-level width setting                          */
            *pcIICWH = R_IIC_CH1_HCLK;                          /* High-level width setting                         */
#endif /* #ifdef IICA1_ENABLE */
        break;
...
void r_iic_drv_per_enable(r_iic_drv_info_t *pRIic_Info)
{
    ...
    switch (pRIic_Info->ChNo)
    {
        ...
        case 1U:
#ifdef IICA1_ENABLE
            R_IIC_IICA1EN = 1U;                                 /* IICA1 enables input clock supply.                */
#endif /* #ifdef IICA1_ENABLE */
        break;
